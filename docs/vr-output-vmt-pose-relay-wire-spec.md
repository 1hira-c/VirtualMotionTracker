...
- M1: fitra-cam に `/fitra/tracked_pose` parser + role bus を追加し、旧 message 互換を維持。
- M2: `extrinsic_calib.controller_role` を config/CLI に追加し、別 controller port を deprecated。
